...
const {elementSelectedInDevtools, debugSuggestionsForElement} = contentScriptFunction(navigation, messageBus, documentMutationsProvider);

export {elementSelectedInDevtools, debugSuggestionsForElement};
